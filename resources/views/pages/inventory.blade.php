...
<div class="flex flex-col space-y-5 p-5">
        <div>
                ...
                <div class="bg-white grid grid-col space-y-3 p-3 pb-5 border-b md:space-y-0 md:grid-cols-2">
                ...
                <div class="bg-white grid-col space-y-3 p-3 pb-5 md:rounded-b-md">
