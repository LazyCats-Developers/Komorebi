    ...
    <div class="flex flex-col md:p-5 items-center">
        <div class="w-full max-w-7xl">
            <div class="flex flex-col space-y-3 md:flex-row md:space-y-0 md:justify-between bg-gray-50 shadow-lg grid-col p-2 border-b md:rounded-t-3xl">
                <p class="font-bold text-xl"><i class="fas fa-user-edit p-3 bg-white rounded-full border"></i> EDITAR PROVEEDOR</p>
            </div>
                ...
                <div class="w-full">
                    ...
                    @csrf
                        ...
                        <div class="flex flex-col gap-3 p-3 lg:flex-row">
                            <input type="text" name="proveedor[nombre]" value="{{$proveedor->nombre}}" class="border border-gray w-full rounded-xl py-3 px-4">
                            <input type="text" name="proveedor[rut]" value="{{$proveedor->rut}}" class="border border-gray w-full rounded-xl py-3 px-4">
                        </div>
                        <div class="flex-col p-3">
                            <p>Datos de Contactos</p>
                        </div>
                        <div class="flex flex-col gap-3 p-3 lg:flex-row">
                            <input type="text" name="proveedor[email]" value="{{$proveedor->email}}" class="border border-gray w-full rounded-xl py-3 px-4">
                            <input type="text" name="proveedor[telefono]" value="{{$proveedor->telefono}}" class="border border-gray w-full rounded-xl py-3 px-4">
                        </div>
                        <div class="flex flex-col gap-3 p-3 lg:flex-row">
                            <input type="text" name="proveedor[direccion]" value="{{$proveedor->direccion}}" class="border border-gray w-full rounded-xl py-3 px-4">
                            <input type="text" name="proveedor[proveedor_rrss]" value="{{$proveedor->proveedor_rrss}}" class="border border-gray w-full rounded-xl py-3 px-4">
                        </div>
