        ...
        <div class="w-full max-w-7xl">
            ...
            {{-- Formulario de el buscador de items  --}}
                ...
                <div class="flex flex-row gap-2">
                    ...
                    <input type="text" value="{{\Session::get('totalventa')}}" placeholder="Total Compra" class="w-full placeholder-gray-400 px-6 py-3 border border-gray-300 text-right md:rounded-r-full md:w-40" disabled>
                </div>
            </div>
